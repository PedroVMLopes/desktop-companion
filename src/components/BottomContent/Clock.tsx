    ...
    return (
        <div className="flex flex-col items-center py-4 text-6xl">
            <div className="grid grid-flow-col gap-2 text-center auto-cols-max font-quicksand">
                <div className="flex flex-col p-2 bg-accent text-accent-content rounded-box shadow-xl border-orange-800 border-l-4 border-b-4">
                    <span className="countdown justify-center p-2">
                        <span style={{ "--value": hours } as React.CSSProperties}></span>
                    </span>
                </div>
                <p className="flex items-center text-3xl font-semibold">:</p>
                <div className="flex flex-col p-2 rounded-box bg-base-200 text-neutral-content shadow-xl border-base-300 border-l-4 border-b-4">
                    <span className="countdown justify-center p-2">
